...
const EmployeeAddTaskProgress = () => {
    ...
    const EmployeeID = 1; //make commend this code,this is manualy Hardcoded EmployeeID=5 , PLZ change this when the login/authentication process has been implemented
